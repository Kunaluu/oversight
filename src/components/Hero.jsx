  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-start text-left">
        ...
        {/* <p className="text-[16px] md:text-[18px] lg:text-[15px] text-gray-500 mt-10 max-w-[550px]">
          A 24/7 surveillance system that uses AI for real-time anomaly
          detection, identifying and categorizing people as intruders (red),
          newcomers (orange), or confidants (green) based on visit frequency,
          and provides alerts and weekly stats
        </p> */}
        <p className="text-[16px] md:text-[18px] lg:text-[15px] text-gray-500 mt-10 max-w-[550px]">
          24/7 surveillance, anomaly detection, visitor categorization, alerts,
          and stats.
        </p>
        <div className="mt-10">
          <GetStarted />
      ...
      {/* Right Column: Video */}
      <div className="flex-1 flex items-center justify-center mt-100 md:mt-0 relative">
        <div className="relative w-[80%] h-[80%] md:w-[60%] md:h-[60%] lg:w-[70%] lg:h-[70%] mt-20 ml-20">
          <video
          ...
          <div className="text-center mt-4">Face recognition demo</div>
        </div>
